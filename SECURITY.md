...
When signed bundles do ship, they will land as a separate `@airo/runtime-verifier` package alongside the L1/L2 sanitiser, with its own threat-model doc and an explicit release note.
